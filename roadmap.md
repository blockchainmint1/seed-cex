...
- [ ] Remove Withdraw UI from spot balances (reads as custodial); keep withdrawals server-side + history
- [ ] "Locked" column: balance sitting in the authorized trading branch per asset
